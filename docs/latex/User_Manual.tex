...
\dmdDocId{}
\dmdIssue{0.1.3}
\dmdDate{6 March 2019}
\dmdPreparedBy{O.\ Czoske}
\dmdPreparedOn{2019-03-06}
\dmdPreparedSig{}
\dmdApprovedBy{}
\dmdApprovedOn{}
\dmdApprovedSig{}
...
SpecCADO relies on a prior installation of SimCADO. Download the
...
\url{https://homepage.univie.ac.at/oliver.czoske/speccado-0.1.3.tar.gz}. Unpack
the tar file and change to the source directory:
\begin{lstlisting}[style=csh]
...
\lstinline{numpy}, and \lstinline{scipy}. \lstinline{wget} is required
for the following step, \lstinline{poppy} is not needed.

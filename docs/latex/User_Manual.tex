...
\dmdDocId{}
\dmdIssue{0.1.3}
\dmdDate{16 February 2019}
\dmdPreparedBy{O.\ Czoske}
\dmdPreparedOn{2019-02-16}
\dmdPreparedSig{}
\dmdApprovedBy{}
\dmdApprovedOn{}
\dmdApprovedSig{}
...
3~arcsec slit. \TODO{Define coordinates.} \TODO{Define requirements on
  the spectral files.}
...
($c=1,\dots,9$) and $i$ and $j$ are the column and row number of a
pixel ($i, j = 1,\dots,4096$).
